...
const previousOperandTextElement = document.querySelector('[class="previous-operand"]')
const currentOperandTextElement = document.querySelector('[class="current-operand"]')
const calculator = new Calculator(previousOperandTextElement, currentOperandTextElement)

const numberButtons = document.querySelectorAll('[class~="number"]')
const operationButtons = document.querySelectorAll('[class~="operator"]')
